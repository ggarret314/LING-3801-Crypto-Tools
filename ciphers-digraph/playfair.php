<div id="page-playfair" class="page">
	...
	<div class="page-content">
		...
		<div class="page-section-title">Manual <input id="playfair-manual-mode" type="checkbox" />
			<div class="control-direction-container">
		...
		<div style="padding: 15px 0;">
			<div><input id="playfair-start-autosolver" type="button" value="Start Auto-Solver (will take some time)"> <input id="playfair-autosolver-type" type="checkbox" checked /> Visual Auto Solver (slower but you can see how the solver works).</div>
